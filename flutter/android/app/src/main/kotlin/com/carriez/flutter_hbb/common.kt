...
// Battery optimization whitelist check and request
// For MIUI/HyperOS and other aggressive battery management systems
const val KEY_BATTERY_OPT_REQUESTED = "KEY_BATTERY_OPT_REQUESTED"
...
fun requestIgnoreBatteryOptimizations(context: Context) {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
        try {
            ...
            Log.e("common", "Failed to request battery optimization exemption: ${e.message}")
            ...
            try {
                ...
                Log.e("common", "Failed to open battery settings: ${e2.message}")
            }
        }
    }
}